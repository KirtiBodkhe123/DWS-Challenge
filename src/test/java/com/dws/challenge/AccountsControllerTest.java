...
class AccountsControllerTest {
  ...
  void transferMoney_successful() throws Exception {
    ...
    this.mockMvc.perform(post(BASE_URL + "/transfer")
  ...
  void transferMoney_insufficientFunds() throws Exception {
    ...
    this.mockMvc.perform(post(BASE_URL + "/transfer")
                    ...
                    .param("amount", "200"))
            .andExpect(status().isBadRequest())
            .andExpect(content().string("Transfer failed: Insufficient balance"));
  }
  ...
  void transferMoney_negativeAmount() throws Exception {
    ...
    this.mockMvc.perform(post(BASE_URL + "/transfer")
                    ...
                    .param("amount", "-100"))
            .andExpect(status().isBadRequest())
            .andExpect(content().string("Transfer failed: Transfer amount must be positive"));
  }
